...
namespace ImageLoader.DAL.Concrete.Repositories
{
    ...
    public class GenericRepository<TEntity> : IGenericRepository<TEntity> where TEntity : class, IPersistentEntity, new()
    {
        #region constructors
        ...
        public GenericRepository(IImageLoaderContext dbContext)
        {
            DbContext = dbContext;
        }
        ...
        {
            return DbContext.Set<TEntity>().Find(id).IsActive ? DbContext.Set<TEntity>().Find(id) : null;
        }
        ...
        {
            return ChangeState(id, Model.Enums.EntityState.Deactive);
        }
        ...
        {
            return ChangeState(id, Model.Enums.EntityState.Active);
        }
        ...
        /// <returns></returns>
        public virtual TEntity ChangeState(Guid id, Model.Enums.EntityState state)
        {
            ...
            switch (state)
            {
                case Model.Enums.EntityState.Active:
                    entity.IsActive = true;
                    break;

                case Model.Enums.EntityState.Deactive:
        ...
        ///
        /// </summary>
        protected readonly IImageLoaderContext DbContext;
